        ...
        <div>
          ...
          <div className="flex gap-4 flex-wrap">
            <Skeleton
              variant="rounded"
              height={106}
              className="max-w-sm grow relative"
            />
          </div>
        </div>
      }
  ...
  if (assosiatedTeam.length === 0)
    return (
      <div className="max-w-prose">
        ...
        <BodyShort spacing>
          Se på <Link href="/kom-i-gang">Kom i gang</Link> for å se hvordan du
          kan assosiere et team med din innlogging. Du finner detaljer om hvilke
          grupper du er medlem i på{" "}
          <Link href="/kom-i-gang/grupper">Kom i gang - Grupper</Link>
        </BodyShort>
        <BodyShort>
          Dersom du allerede vet hvilken gruppe-id du skal bruke, kan du koble
          til teamet ditt ved å bruke
          <Code>/helsesjekk assign gruppe-id</Code> i kanalen hvor botten er
          aktivert.
        </BodyShort>
      </div>
    );
