    ...
    <div className="max-w-prose">
      ...
      >
        ...
        <LinkPanelDescription>
          Graf over utviklingen av teamhelse over tid
        </LinkPanelDescription>
      </LinkPanel>
      <LinkPanel
        as={Link}
      ...
      >
        ...
        <LinkPanelDescription>
          Alle gyldige tidligere resultater
        </LinkPanelDescription>
      </LinkPanel>
      ...
      <Questions
        teamId={team.id}
        questions={questionsFromJsonb(team.questions)}
      />
    </div>
  );
}
    ...
    <div className="p-3 bg-bg-subtle rounded my-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <BodyShort spacing>
            Spørringen blir lukket og vist på {dayIndexToDay(revealDay)} kl.{" "}
            {revealHour}
          </BodyShort>
          <a
            href={createPermalink(teamId, askTs)}
            target="_blank"
            rel="noreferrer"
          >
            ...
            <ul className="flex flex-col gap-3">
              {questions.map((question) => (
                <li
                  ...
                  className="bg-bg-subtle p-3 pt-2 rounded relative"
                >
